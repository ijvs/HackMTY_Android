...
public class UserHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UserHistoryAdapter(Context mContext, ArrayList<User> users) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new UserHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_user_history, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        userHolder.date.setText(user.date);
        userHolder.stars.setText(user.stars + " estrellas");
